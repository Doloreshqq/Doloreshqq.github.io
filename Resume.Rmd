...
<i>Statistics-based XAI approach for neural network decision analysis</i> <span style="float: right;">Jul, 2023 - present</span>
...
- **Results:** Successfully establish a neural network interpretation framework for hand-written digit recognition. Methods proven with higher accuracy, robustness, and sensitivity to global and local texture information compared with the existing method.
...
<i>Big Traffic Data Competition (Group of 5)</i> <span style="float: right;">May, 2020 - Nov, 2020</span>

- Conducted data collecting from the given platform, applied value decomposition and noise reduction to process data-cleaning.

- **Results:** Successfully predicted the average traffic flow at an intersection based on team members’ innovative temporal-spatial KNN algorithm, where we applied dynamic time warping (DTW) to undergo similarity measurements of the varied sections.

- **Award:** Won second place nationwise
